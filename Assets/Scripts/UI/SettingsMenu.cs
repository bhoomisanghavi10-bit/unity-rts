...
namespace KingdomsOfBharat.UI
{
    ...
    public class SettingsMenu : MonoBehaviour
    {
        ...
        private static readonly RebindableAction[] Actions =
        {
            ...
            new RebindableAction("TrainChara", "Train Scout (Barracks)", KeyCode.F),
            new RebindableAction("TrainSkirmisher", "Train Skirmisher (Barracks)", KeyCode.C),
            new RebindableAction("TrainBatteringRam", "Train Battering Ram (Barracks)", KeyCode.D),
            new RebindableAction("TrainCavalryArcher", "Train Cavalry Archer (Barracks)", KeyCode.K),
            ...
            new RebindableAction("ResearchSpearmanTier", "Upgrade Spearman Tier (Barracks)", KeyCode.L),
            new RebindableAction("ResearchArcherTier", "Upgrade Archer Tier (Barracks)", KeyCode.H),
            new RebindableAction("ResearchCavalryTier", "Upgrade Cavalry Tier (Barracks)", KeyCode.M),
            new RebindableAction("ResearchSiegeTier", "Upgrade Siege Tier (Barracks)", KeyCode.O),
            new RebindableAction("ResearchElephantTier", "Upgrade Elephant Tier (Durg)", KeyCode.R),
            new RebindableAction("ResearchEliteTier", "Upgrade Elite Tier (Durg)", KeyCode.F),
            new RebindableAction("ResearchEliteTier2", "Upgrade 2nd Elite Tier (Durg)", KeyCode.G),
            new RebindableAction("ResearchCharaTier", "Upgrade Scout Tier (Barracks)", KeyCode.G),
            new RebindableAction("ResearchSkirmisherTier", "Upgrade Skirmisher Tier (Barracks)", KeyCode.V),
