...
namespace KingdomsOfBharat.UI
{
    ...
    public class SettingsMenu : MonoBehaviour
    {
        ...
        private static readonly RebindableAction[] Actions =
        {
            ...
            new RebindableAction("TrainUniqueUnit", "Train Unique Unit (Barracks)", KeyCode.Q),
            new RebindableAction("TrainUniqueUnit2", "Train 2nd Unique Unit (Barracks)", KeyCode.Z),
            new RebindableAction("ResearchAttack", "Research Attack (Barracks)", KeyCode.U),
            new RebindableAction("ResearchArmor", "Research Armor (Barracks)", KeyCode.K),
