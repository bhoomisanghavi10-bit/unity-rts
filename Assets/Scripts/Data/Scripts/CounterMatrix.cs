...
public class CounterMatrix : ScriptableObject
{
    ...
    private Dictionary<(UnitClass, UnitClass), float> _lookup;

    public float GetMultiplier(UnitClass attacker, UnitClass defender)
    {
    ...
    {
        _lookup = new Dictionary<(UnitClass, UnitClass), float>();
