...
namespace KingdomsOfBharat.FogOfWar
{
    ...
    public class FogOfWarManager : MonoBehaviour
    {
        ...
        // Deliberately separate from the shared FindShader() helper used by
        // opaque gameplay objects elsewhere: URP's Lit shader defaults to an
        // opaque surface, so a translucent fog overlay needs a shader that's
        // actually unlit/blend-capable, not just a color with alpha set.
        private static Shader FindFogShader()
        {
